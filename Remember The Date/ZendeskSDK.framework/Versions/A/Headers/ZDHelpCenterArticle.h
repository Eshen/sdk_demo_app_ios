...
@interface ZDHelpCenterArticle : NSObject
 ...
 *
 * @return A new ZDHelpCenterArticle.
 */
+ (ZDHelpCenterArticle *) parseArticle:(NSDictionary *)articleJson;


/**
 * Parses a collection of Help Center json article objects.
 *
 * @return An array of ZDHelpCenterArticle objects.
 */
