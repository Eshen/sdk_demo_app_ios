//
//  ZDHelpCenterCategoryDataSource.h
//  ZDHelpCenter
//
...
@class ZDHelpCenterProvider;


/**
 * A block for configuring cells. This is invoked in cell for row at index path.
 */
typedef void (^ZDHelpCenterCellConfigureBlock)(id cell, id item);


/**
 * The support view that displays help center content.
 */
@interface ZDHelpCenterDataSource : NSObject <UITableViewDataSource>
...
- (instancetype) initWithcellIdentifier:(NSString *)aCellIdentifier
                     configureCellBlock:(ZDHelpCenterCellConfigureBlock)aConfigureCellBlock
