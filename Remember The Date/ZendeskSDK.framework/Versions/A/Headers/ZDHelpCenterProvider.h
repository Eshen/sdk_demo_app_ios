 ...
 *
 */
typedef void (^ZDHelpCenterCallback)(NSArray *items, NSError *error);



@interface ZDHelpCenterProvider : NSObject
 ...
 */
+ (void) items:(ZDHelpCenterCallback)callback parent:(NSString *)parentId;
