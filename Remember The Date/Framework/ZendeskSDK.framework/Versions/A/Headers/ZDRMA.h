 ...
 */
+ (void) configure:(void (^)(ZDAccount*, ZDRMAConfigObject *config))configBlock;
 ...
 *
 * @discussion If ZDRMA is not properly configure this mithed will log an error and return.
 ...
 * decide if the dialog should be shown.
 *
 * @discussion Ignore the RMA configuration and present the dialog everytime.
 * @param view A view that RMA will be displayed over.
 */
+ (void) showEveryTimeInView:(UIView*)view;
