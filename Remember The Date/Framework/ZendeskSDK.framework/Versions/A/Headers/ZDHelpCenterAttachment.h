...
@interface ZDHelpCenterAttachment : NSObject
 ...
 *
 * @return A new ZDHelpCenterAttachment.
 */
+ (ZDHelpCenterAttachment *) parseAttachment:(NSDictionary *)attachmentJson;
